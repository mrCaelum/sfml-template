...
: _window{video, title, style, settings}, _clock{}, _font{}, _currentScene{Scene::MENU}
{
    _window.setFramerateLimit(framerate);
    _font.loadFromFile("assets/fonts/Roboto.ttf");
    _scenes.push_back(std::make_unique<Menu>(_window, _font));
    _scenes.push_back(std::make_unique<Game>(_window));
}
