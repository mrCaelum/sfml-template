...
TextButton::TextButton(sf::String const &text, sf::Font const &font, sf::Vector2f const &position, unsigned int const size, sf::Color const &color, sf::Color const &outline_color, float const outline_thickness, Origin const origin, TextAnimation const &hovered, TextAnimation const &clicked)
